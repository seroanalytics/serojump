...
data_exp <- get_data_titre_nih_2023_h3()
...
runInfRJMCMC(seroModel, settings, "local/nih_2024/test", "h3")

postprocessFigs("local/nih_2024/test", "h3", 4)
...
postprocessFigs_wave2("test/nih_2024", "h3_profile", 4)
