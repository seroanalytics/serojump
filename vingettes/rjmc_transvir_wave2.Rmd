...
par_tab <- bind_rows(
    add_par_df("a_vax", 0.0, 1.5, "norm",  1, 0.5), # ab kinetics
    add_par_df("b_vax", 0, 1, "norm",  0.3, 0.05), # ab kinetics
    add_par_df("c_vax", -1.0, 4, "unif", -1,  4), # ab kinetics 
    add_par_df("a_pd", 0.0, 1.5, "norm",  1, 0.5), # ab kinetics
    add_par_df("b_pd", 0, 1, "norm",  0.3, 0.05), # ab kinetics
    add_par_df("c_pd", -1.0, 4, "unif", -1,  4), # ab kinetics
    add_par_df("a_d", 0.0, 1.5, "norm",  1, 0.5), # ab kinetics
    add_par_df("b_d", 0, 1, "norm",  0.3, 0.05), # ab kinetics
    add_par_df("c_d", 0.5, 4, "unif", 0.5,  4), # ab kinetics

    add_par_df("tau", 0, 1, "unif", 0, 1), # titre-dep boosting  

    add_par_df("wane", 0.0, 0.1, "unif", 0.0, 0.1), # observational model
    add_par_df("sigma_obs_not", 0.01, 5, "unif", 0.01, 5), # observational model
...
# Checks exposure historgram compared to data

```{r}

# Useful function comparison of known infection times and histogram of exposure prior 
