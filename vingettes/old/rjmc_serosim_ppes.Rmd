...
ggsave(here::here("outputs", "sim", "ppes", "figs", paste0("obs_", obs_er), "ab_kinetics_recov.png"), height = 10, width = 10)
...
p3 <- jump_format_inf$pooled %>% 
    ...
    geom_point(aes(x = initialTitreValue, y = prop_inf, color = as.character(value), shape = known), 
        size = 4, alpha = 0.6, position = position_jitter(height = 0.01)) + 
...
ggsave(here::here("outputs", "sim", "ppes", "figs", paste0("obs_", obs_er), "inf_recov.png"), height = 20)
...
#ggsave(here::here("outputs", "sim", "ppes", "figs", "inf_recov_chain.png"), height = 20)
...
#ggsave(here::here("outputs", "sim", "ppes", "figs", "inf_recov_pooled.png"), height = 20)
...
p1 / p2
ggsave(here::here("outputs", "sim", "ppes", "figs", paste0("obs_", obs_er), "cop_recov.png") )
