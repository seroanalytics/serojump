...
library(devtools)
#install(here::here("..", "serojump")) # install working version of this package 
library(serojump)
#library(lubridate)
#library(patchwork)
#library(tidybayes)
...
plotPostFigsInf(model_summary_cop, sim_model_cop, sim_res_cop, save_info = save_info_cop)
...
plotPostFigsInf(model_summary_no_cop, sim_model_no_cop, sim_res_no_cop, save_info = save_info_no_cop)
