...
test_that("addPriorHier Check that addPrior makes correct dataframe", {
        ...
        expect_equivalent(addPriorHier("alpha", 0, 1, "unif", 1, 5, "exp", 1, NA, 2),
            ...
            bind_rows(
                ...
                data.frame(par_name = "z_alpha_1", lb = -10, ub = 10, dist = "norm", dist_par1 = "0", dist_par2 = "1", part_type = "hprior"),
                data.frame(par_name = "z_alpha_2", lb = -10, ub = 10, dist = "norm", dist_par1 = "0", dist_par2 = "1", part_type = "hprior"),
                data.frame(par_name = "sigma_alpha", lb = 0, ub = 5, dist = "exp", dist_par1 = "1", dist_par2 = NA, part_type = "hprior")
            )
        )
    }
)
